...
export const PROMPTS = [
  ...
  },
  {
    ...
    image: 'prompts/birthday-calendar.webp',
    prompt: "A soft elegant Indian birthday calendar poster portrait with a dual-pose composition.\n\nSUBJECT (use uploaded photo as facial identity reference — 100% face preservation, identity lock ON):\nA young South Asian woman with a bridal/festive look. She has dark black hair styled in an elegant updo bun adorned with pink and peach flowers (roses/gerbera) on the side. She wears a soft blush pink silk saree with delicate gold floral embroidery and a matching embroidered blouse. Her jewellery includes a gold maang tikka, a gold nose ring (nath), large dangling gold jhumka earrings, layered gold necklaces (long haar and choker style), stacked gold and multicolor bangles on both wrists, and a small red bindi.\n\nPOSE 1 (left side, half body): The woman in a gentle half-body pose, slightly leaning forward, one hand raised near her cheek/chin, looking upward with a soft dreamy smile. Natural, graceful, relaxed posture.\n\nPOSE 2 (right side, close-up): A large close-up portrait of the same woman's face from a slightly different angle — looking upward gently with a calm, soft expression. This close-up is positioned in the lower right half of the poster, large and prominent.\n\nBACKGROUND: Warm antique dusty rose and cream textured plaster wall. Fresh green leafy vine/ivy climbing on the upper left corner.\n\nLAYOUT — TWO-PANEL DESIGN:\nLeft half: The photographic portrait (Pose 1 full body + Pose 2 close-up bleeding into the right side).\nRight half upper: A clean warm beige/cream decorative panel with the following text and design elements:\n\nTEXT LAYOUT (right panel, top to bottom):\n— Small serif uppercase text: \"{input_text_1}\"\n— Large elegant calligraphy script below: \"{input_text_2}\"\n— Small decorative gold botanical leaf illustration beside the title\n— Italic serif subtext: \"{input_text_3}\"\n— A thin horizontal divider line with a small heart center ornament\n— Decorative rectangular border box containing:\n  Left side: \"{input_text_4}\" (month name, bold caps) + \"{input_text_5}\" (year, small)\n  Right side: \"{input_text_6}\" (large bold date number)\n  Small pink flower illustration beside the box\n— Small botanical/floral watercolor accent illustrations nearby\n\nBOTTOM LEFT PANEL (over photo area):\n— Full monthly calendar grid with days: SUN MON TUE WED THU FRI SAT\n  All dates for the month listed\n  Birthday date \"{input_text_6}\" circled with a thin ring\n— Thin horizontal divider with gold scroll ornament\n— Italic body text: \"{input_text_7}\"\n— Small gold botanical flower illustration at the very bottom\n\nCOLOR PALETTE: Dusty blush rose, antique gold, warm cream/beige, soft green botanical accents, muted pink florals.\n\nTYPOGRAPHY STYLE: Elegant serif + flowing calligraphy script combination, warm dark brown/gold text color throughout.\n\nLIGHTING: Soft warm diffused natural light, gentle portrait glow, no harsh shadows.\n\nSTYLE: Premium Indian birthday portrait poster, editorial bridal photography aesthetic, soft romantic watercolor design elements, ultra-realistic photography composite, portrait orientation 3:4, 8K.",
    placeholders: [
  ...
  },
  {
    ...
    prompt: "A cinematic, intimate studio portrait of a young woman photographed from behind, standing in front of a large ornate antique mirror, her face visible only through the mirror's reflection.\n\n——————————————————————————————\nFACE & IDENTITY REFERENCE:\n——————————————————————————————\nUse the uploaded photo as the sole facial identity reference.\nThe face appears ONLY inside the mirror reflection — preserve 100% facial features, skin tone, eye shape, bindi placement, nose, lips, and complete likeness with photorealistic accuracy.\nThe face in the mirror must be clearly recognizable as the same person from the reference photo.\nSmall traditional bindi on forehead. Natural minimal makeup.\nSoft genuine smile in the reflection.\n\n——————————————————————————————\nSUBJECT — BACK VIEW (primary, right side of frame):\n——————————————————————————————\nYoung Indian woman, standing and slightly turned toward the mirror.\nSeen entirely from behind — back of head, long flowing hair, and full back visible.\n\nHAIR: Very long, straight, dark black hair falling freely down the back. Hair is loose with a natural slight part. A string of small white jasmine flowers (gajra) is loosely placed/woven along the hair near the shoulder.\n\nOne hand raised — gently holding a strand of hair near the shoulder level, delicate natural gesture.\n\nOUTFIT: Deep chocolate brown / dark mocha saree with neat pleats and drape visible from the back. Matching dark brown short-sleeve blouse with slight puff at shoulder seam (traditional cut).\n\nACCESSORIES:\n- Black smartwatch on wrist of raised hand\n- Thin gold bangle on wrist\n- (Necklace and bindi visible only in mirror reflection)\n\n——————————————————————————————\nMIRROR — ANTIQUE FLOOR MIRROR:\n——————————————————————————————\nLarge, tall, floor-length standing mirror positioned slightly left of center frame.\nFrame: Ornate antique dark bronze/brown carved wood or metal frame with elaborate decorative scrollwork and floral motifs at the top crown. Aged, regal, heritage aesthetic.\nThe mirror reflection shows:\n- The woman's face front-on, with soft warm lighting\n- A soft warm amber/golden light source (like a vintage lamp or warm bulb) glowing in the background of the reflection behind her\n- The reflection lighting is warm, intimate, slightly softer than the main scene\n- The reflection is crisp and realistic — not distorted\n\n——————————————————————————————\nLIGHTING SETUP:\n——————————————————————————————\nMAIN SCENE: Dramatic low-key studio lighting.\n- Warm golden/amber rim light hitting the subject from behind and slightly left — illuminating the edges of her hair (creating a luminous hair glow), shoulder, and the curve of her back.\n- Rest of the scene falls into deep shadow.\n- Strong chiaroscuro contrast (light vs dark).\n\nMIRROR REFLECTION: Softer, warmer interior lighting — as if a warm vintage lamp is glowing inside the space shown in the reflection. Face is warmly lit, soft shadows, intimate glow.\n\nBACKGROUND: Pure solid black / near-black dark studio backdrop. No distractions. All attention on subject and mirror.\n\n——————————————————————————————\nCOLOR PALETTE:\n——————————————————————————————\nDominant: Deep chocolate brown (#3B1F0E), pure black (#0A0A0A)\nAccents: Warm amber gold (#C8860A) — rim light and lamp glow\nSkin: Warm medium-brown South Indian skin tone\nWhite: Small jasmine flowers accent\nOverall: Dark, warm, moody, cinematic tones\n\n——————————————————————————————\nTECHNICAL & STYLE SPECS:\n——————————————————————————————\nAspect ratio: 4:5 portrait\nResolution: 8K ultra-detailed photorealistic\nCamera: Shot as if with 85mm portrait lens, f/1.8 — slight background separation, tack-sharp subject\nStyle: High-end Indian fashion/editorial photography\nMood: Cinematic, intimate, elegant, traditional-modern fusion\nLighting reference: Rembrandt + rim light combination\nNO text, watermarks, or overlays\n\nCRITICAL RULES:\n— The back of the subject must NOT show the face at all\n— Face appears EXCLUSIVELY in the mirror reflection\n— Mirror reflection face must be 100% identity-accurate to the uploaded reference photo\n— Do not alter skin tone, facial structure, or any features",
  ...
  },
  {
    ...
    prompt: "A photorealistic forced-perspective miniature scene — a tiny adult person (clearly adult proportions and features) standing and hugging an oversized chocolate bar that is larger than their entire body.\n\n——————————————————————————————\nFACE & IDENTITY REFERENCE:\n——————————————————————————————\nUse the uploaded photo as the sole facial identity reference. Preserve 100% facial features, skin tone, hair, and complete adult likeness with photorealistic accuracy.\nThe subject is CLEARLY an adult — adult body proportions, adult face, adult hands.\nExpression: Joyful, cheeky grin — chocolate smeared slightly on cheek and hands — caught mid-indulgence.\n\n——————————————————————————————\nTHE MINIATURE ADULT FIGURE:\n——————————————————————————————\nA fully grown adult rendered at miniature scale — approximately thumb-sized relative to the chocolate bar they are holding.\n\nBODY PROPORTIONS: Completely normal adult proportions — NO big head, NO chibi distortion, NO child-like features. This is a real adult person who simply appears very small.\n\nHEIGHT relative to bar: The person is approximately the same height as the chocolate bar — the bar reaches from their feet to above their head.\n\nPOSE: Full body visible — standing upright, both arms wrapped around the chocolate bar in a full bear hug. Leaning cheek against the bar lovingly. Knees slightly bent — squeezing it tight with visible effort and joy.\nFeet planted on the ground surface.\n\nOUTFIT:\n- Warm beige/camel knit sweater — cozy, slightly oversized\n- Brown corduroy or denim dungaree/overalls over the sweater\n- Dark brown lace-up ankle boots\n- Casual, warm, autumn/cozy aesthetic\n\nCHOCOLATE DETAILS ON PERSON:\n- Smear of melted chocolate on one cheek\n- Chocolate-smudged fingertips and hands\n- Small drip on chin\n- Adds to the playful \"caught eating\" narrative\n\n——————————————————————————————\nTHE OVERSIZED CHOCOLATE BAR:\n——————————————————————————————\nA giant \"{input_text_1}\" chocolate bar — rendered photorealistically at oversized scale.\n\nThe bar is the SAME SIZE as a real KitKat/chocolate bar — the PERSON is miniaturized to create the scale illusion.\n\nBAR DETAILS:\n- Iconic red and white wrapper — partially torn open at the top\n- Chocolate wafer visible where wrapper is torn — showing the layered interior\n- Melted chocolate dripping slowly down the sides of the bar\n- Wrapper has slight crinkle and texture — looks real and handled\n- The bar stands vertically, slightly angled\n\nCHOCOLATE DRIPS: Melted chocolate drops and puddles on the ground surface around the base of the bar — adds to the \"being eaten\" storytelling.\n\n——————————————————————————————\nBACKGROUND & SURFACE:\n——————————————————————————————\nClean, minimal, warm neutral studio:\n\nSURFACE: Smooth matte warm beige/cream surface — like a studio floor or clean tabletop. The tiny person stands directly on this surface.\n\nBACKGROUND: Soft warm beige-cream gradient — slightly darker at edges (subtle vignette).\nNo props, no distractions — all focus on the person + bar.\n\nMacro photography aesthetic — the background is beautifully soft bokeh, suggesting the scene was photographed with a macro lens.\n\n——————————————————————————————\nCAMERA & LENS EFFECT:\n——————————————————————————————\nShot as if with a macro/close-up lens:\n- Camera angle: Slightly above eye level — looking slightly DOWN at the tiny figure, giving a \"giant looking at a tiny person\" perspective\n- The tiny person looks UP slightly — making eye contact with the \"camera/viewer\"\n- Shallow depth of field — figure and bar are sharp, background is beautifully soft bokeh\n- The scale illusion is PHOTOGRAPHIC — not CGI — it looks like a real macro photography forced perspective shot\n\n——————————————————————————————\nLIGHTING:\n——————————————————————————————\nSoft, clean, warm studio lighting:\n- Soft diffused light from upper left\n- Subtle warm fill from right side\n- No harsh shadows — soft natural shadows beneath the figure's feet grounding them\n- The chocolate bar has a slight sheen — catching studio light on wrapper\n- Melted chocolate has a glossy, wet look\n- Skin: Natural warm tone, evenly lit\n\n——————————————————————————————\nCOLOR PALETTE:\n——————————————————————————————\nBackground: Warm cream/beige (#F5EDD8)\nOutfit: Warm camel knit + brown corduroy\nChocolate bar wrapper: Bold red (#CC0000) + white\nChocolate: Rich milk chocolate brown (#6B3A2A)\nMelted drips: Glossy dark brown (#4A2010)\nSkin: Natural warm adult skin tone\nOverall: Warm, cozy, appetizing — chocolate advertisement aesthetic\n\n——————————————————————————————\nTECHNICAL SPECS:\n——————————————————————————————\nAspect ratio: 4:5 portrait\nResolution: 8K ultra-detailed photorealistic\nStyle: High-end forced perspective macro photography / creative advertising\nScale illusion: Must feel PHOTOGRAPHIC and BELIEVABLE — not composite or CGI\nQuality: Premium chocolate brand advertisement level\n\nCRITICAL RULES:\n— Subject MUST have adult body proportions — absolutely no child-like features\n— NO other adult hands in the frame — person interacts with bar only\n— The scale illusion comes from TINY PERSON not giant bar — bar is normal size, person appears miniaturized\n— Chocolate smears on hands/face add character — keep them\n— Face must be 100% identity-accurate to uploaded reference\n— The person must look JOYFUL — this is a fun, positive image",
    placeholders: [
